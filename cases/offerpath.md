...
个人项目主要使用 **ChatGPT、Codex**辅助开发，贯穿需求梳理、代码理解、实现与调试，由我检查生成结果、验证流程并承担交付责任。

OfferPath 是 **Web 应用，采用 B/S 架构**：浏览器中的 React / TypeScript 前端访问 Workers API，服务端连接 D1 并处理认证和数据所有权。响应式移动网页属于 Web 使用形态，不等于原生 iOS / Android App。
## 业务问题与我的职责
